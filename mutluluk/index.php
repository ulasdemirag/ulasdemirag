...
$tarih1 = new DateTime("2022-12-27");
...
<head>
    ...
    <title>Ulas❤️Sude <?php echo $interval->days ?> </title>
            ...
            <div class="ay">
                    <div class="row p-0 m-0 h-100 text-white text-center ">
                        <div class="col-md-12 text-white text-center">
                            <img src="img/ft1.jpg" alt="" class="img-fluid aycan-img" >
                            <img src="img/ft2.jpg" alt="" class="img-fluid aycan-img" >
                            <img src="img/foto3.jpeg" alt="" class="img-fluid aycan-img" >
                            <p class="lead" id="mesaj"><?php echo $kac_var['mi'] ?> Kişi Maşallah Dedi 😊 </p>
                            <form action="" method="post">
                                <button type="submit" name="mutluluk" id="dilekgonder" class="btn btn-aycan">Maşallah de </button>
                            </form>
                        </div>
                        <div class="col-md-12 d-flex align-items-center justify-content-center">
                        <?php
     ...
     $("#dilekgonder").on("click", function (event) {
         ...
         $.ajax({
             ...
             success: function (cevap) {
                 $('#mesaj').html( "<p class='lead'> Maşallah diyen <span class='badge badge-danger'>" + cevap + "</span> . Kişisin 😍 <br> 🙈 Teşekkürler </p>");
             }
         });
     });
 </script>
